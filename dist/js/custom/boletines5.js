document.addEventListener("DOMContentLoaded", function () {
  ...
  const cortina = document.querySelector('#cortina-de-espera')
  ...
  (async () => {
    ...
    try {
      ...
      document.querySelectorAll(".btn-bol-pdf5").forEach((el) => {
        el.addEventListener("click", function () {

          cortina.removeAttribute('style', 'overflow-y: auto; display:none;')
          cortina.setAttribute('style', 'overflow-y: auto; display:flex;')
          /////////////////////////////////////////////////////////
          // let aluId = el.value;
          ...
          if (gradoNum in gradosDesc) {
            ...
            descGrado = gradosDesc[gradoNum]["grado"];
          }
          ...
          const consultaAlumnos = async () => {
            try {
              ...
              if (dataServer.respuesta === "exito") {
                  ...
                  if (datAlumnos.hasOwnProperty(aluId)) {
                          ...
                          table: {
                            ...
                            body: [
                              [
                                ...
                                {
                                  text: "INFORME ACADÉMICO FINAL - CENTRO PEDAGÓGICO LA INMACULADA",
                                  style: "tableTitulo",
                                  colSpan: 8,
                                  alignment: "center",
                                  fontSize: 9,
                    ...
                    if (alumSector != "TRA") {
                      const notIcfes = async () => {
                        ...
                        let icf_rangos;
                        if (
                          datMat.gra_esc === "PRIMERO" ||
                          datMat.gra_esc === "SEGUNDO"
                        ) {
                          ...
                          icf_rangos =
                            "0 - 120 (INSUFICIENTE), 121 - 140 (BÁSICO), 141 - 200 (SATISFÁCTORIO), 201 - 250 (AVANZADO)";
                        } else {
                          ...
                          icf_rangos =
                            "0 - 199 (INSUFICIENTE), 200 - 270 (BÁSICO), 270 - 320 (SATISFÁCTORIO), 321 - 400 (AVANZADO)";
                        }
                    ...
                    const datosFirma = async () => {
                      ...
                      const firmaRutaBase64 = await convertirImagenABase64(
                        blobFirma
                      );
                ...
                cortina.removeAttribute('style', 'overflow-y: auto; display:flex;')
                cortina.setAttribute('style', 'overflow-y: auto; display:none;')
