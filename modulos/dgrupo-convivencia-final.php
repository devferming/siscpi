      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Grado: <strong><span><?php echo $grado_desc; ?></span></strong> &nbsp Periodo: <strong><span><?php echo $periodo; ?></span></strong></h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="tablageneral" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                while ($row  = $result->fetch_assoc()) {
                  ...
                  if ($dat_alum['gra_esc'] == $grado_desc) {
                    ...
                    try {
                        if ($notas_resultado->num_rows > 0) {
                          ...
                          $convivencia_p1 = isset($notas["p-1"]['ncv']) ? $notas["p-1"]['ncv'] : 0;
                          $convivencia_p1 = number_format((float)$convivencia_p1, 1, '.', '');
                          
                          $convivencia_p2 = isset($notas["p-2"]['ncv']) ? $notas["p-2"]['ncv'] : 0;
                          $convivencia_p2 = number_format((float)$convivencia_p2, 1, '.', '');

                          $convivencia_p3 = isset($notas["p-3"]['ncv']) ? $notas["p-3"]['ncv'] : 0;
                          $convivencia_p3 = number_format((float)$convivencia_p3, 1, '.', '');

                          $convivencia_p4 = isset($notas["p-4"]['ncv']) ? $notas["p-4"]['ncv'] : 0;
                          $convivencia_p4 = number_format((float)$convivencia_p4, 1, '.', '');

                          $convivencia = ($convivencia_p1 + $convivencia_p2 + $convivencia_p3 + $convivencia_p4) / 4;
                    ...
                    <tr>
                      <td>
                        ...
                        <span class="badge badge-pill badge-<?php echo $bandera ?>"> Def: <?php echo $final_convivencia ?></span><br>
